...
(async function() {
    ...
    const translations = {
        en: {
            ...
            rp_content: [
                "<p><strong>Effective date: 31 August 2026</strong></p>",
                "<p>This policy applies to Zenqor Technologies' business consulting, digital transformation, digital-system development and digital-skills development services. It should be read with the quotation, proposal, service agreement or statement of work for the relevant engagement. Where those documents set a specific term for that engagement, that specific term applies to the extent permitted by law.</p>",
        ...
        ms: {
            ...
            rp_content: [
                "<p><strong>Tarikh kuat kuasa: 31 Ogos 2026</strong></p>",
                "<p>Polisi ini terpakai kepada perkhidmatan perundingan perniagaan, transformasi digital, pembangunan sistem digital dan pembangunan kemahiran digital oleh Zenqor Technologies. Polisi ini perlu dibaca bersama sebut harga, cadangan, perjanjian perkhidmatan atau skop kerja bagi penglibatan berkenaan. Jika dokumen tersebut menetapkan terma khusus, terma khusus itu terpakai setakat yang dibenarkan oleh undang-undang.</p>",
